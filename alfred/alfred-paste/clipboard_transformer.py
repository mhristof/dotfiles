...
class AlfredResult:
    ...
    def __init__(
        self, uid: str, title: str, subtitle: str, arg: str, valid: bool = True
    ):
        self.uid = uid
        self.title = title
...
class ClipboardTransformer:
                ...
                if matching_verbs:
                    ...
                    results.append(
                        AlfredResult(
                            ...
                            subtitle="Available: "
                            + ", ".join([f"p{v}" for v in available_verbs]),
                            arg="",
                            valid=False,
                        )
                    )
    ...
    def output_alfred_results(self, results: List[AlfredResult]):
        ...
        alfred_output = {"items": [result.to_dict() for result in results]}
